...
Julia library for firmware integrity auditing and verification. Provides
tools for checksumming, cryptographic verification, and detailed audit
reporting on firmware images and system binaries.
...
* Uses Julia’s multiple-dispatch for flexible hash/verification
strategies
