= Firmwareaudit.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/FirmwareAudit.jl
cd FirmwareAudit.jl
...
* https://github.com/hyperpolymath/FirmwareAudit.jl/issues — report bugs
