...
doctor:
    @echo "Running diagnostics for FirmwareAudit.jl..."
...
help-me:
    @echo "=== FirmwareAudit.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/FirmwareAudit.jl/issues/new"
    @echo ""
